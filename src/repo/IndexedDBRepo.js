...
class IndexedDBRepo extends RepositoryInterface {
    constructor() {
        super();
        this.db = null;
    }
    ...
    async init() {
        return new Promise((resolve, reject) => {
            ...
            request.onblocked = () => {
                reject(new Error('Database blocked. Please close other tabs/windows and refresh.'));
            };
            ...
            request.onerror = (e) => {
                ...
                reject(new Error('Database error. See console for details.'));
            };
        });
    }
